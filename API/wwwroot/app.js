...
import { auth, isAuthenticated, requireAuth, clearSession, redirectToLogin, restoreUserState } from './auth.js';
...
async function submitReport() {
  ...
  try {
    ...
    showToast(err.message || 'Server not reachable.', true);
    return;
  }
...
async function init() {
  ...
  // Detect API base and restore user session before updating UI
